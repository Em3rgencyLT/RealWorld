...
public class GSDRoadSystemEditor : Editor
{
    ...
    protected GSDRoadSystem GSDRS => (GSDRoadSystem) target;
...
//	Vector3 CameraCustomRot = new Vector3(0.5f,0f,-0.5f);
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (GSDRS.EditorPlayCamera == null) GSDRS.EditorCameraSetSingle();
        Line();
...
//		}
        ...
        if (GUI.changed)
        {
            ...
            if (bUpdateGlobal_Multithread) GSDRS.UpdateAllRoads_MultiThreadOptions();

            //Save mesh assets global change:
            if (bUpdateGlobal_SaveMesh) GSDRS.UpdateAllRoads_SaveMeshesAsAssetsOptions();
        }
    }
