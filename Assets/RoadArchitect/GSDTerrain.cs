...
namespace RoadArchitect
{
    ...
    {
#if UNITY_EDITOR
        [SerializeField] [HideInInspector] private int mGSDID = -1;
        ...
        [HideInInspector] public Terrain tTerrain;
        ...
        {
            var tTerrainObjs = FindObjectsOfType(typeof(GSDTerrain));
