...
public class GSDRoadIntersection : MonoBehaviour
{
    ...
    {
        if (UID == null || UID.Length < 4) UID = System.Guid.NewGuid().ToString();
    }
    ...
    {
        if (tNode.GSDSpline == xNode.GSDSpline) bSameSpline = true;
    ...
    {
        BoundsRect = null;
        BoundsRect = new GSD.Roads.GSDRoadUtil.Construction2DRect(new Vector2(CornerRR.x, CornerRR.z),
    ...
    public bool ContainsLine(Vector3 tVect1, Vector3 tVect2)
    {
        ...
        var bIntersects = Intersects2D(ref tVectStart, ref tVectEnd, ref CornerRR_2D, ref CornerRL_2D);
    ...
    private static bool Intersects2D(ref Vector2 Line1S, ref Vector2 Line1E, ref Vector2 Line2S, ref Vector2 Line2E)
    {
        ...
        float s, t;
        s = (-firstLineSlopeY * (Line1S.x - Line2S.x) + firstLineSlopeX * (Line1S.y - Line2S.y)) /
            (-secondLineSlopeX * firstLineSlopeY + firstLineSlopeX * secondLineSlopeY);
        t = (secondLineSlopeX * (Line1S.y - Line2S.y) - secondLineSlopeY * (Line1S.x - Line2S.x)) /
            (-secondLineSlopeX * firstLineSlopeY + firstLineSlopeX * secondLineSlopeY);
    ...
    private void CreateFixedSequence()
    {
        ...
        {
            SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.LeftTurn,
                GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_LeftTurnLightLength);
        ...
        {
            SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.LeftTurn,
                GSDTrafficLightController.iLightSubStatusEnum.Yellow, opt_FixedTime_YellowLightLength);
            FixedTimeSequenceList.Add(SMaker);
        }

        SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.Red,
            GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_AllRedLightLength);
        FixedTimeSequenceList.Add(SMaker);
        SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.Regular,
            GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_RegularLightLength);
        FixedTimeSequenceList.Add(SMaker);
        SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.Regular,
            GSDTrafficLightController.iLightSubStatusEnum.Yellow, opt_FixedTime_YellowLightLength);
        FixedTimeSequenceList.Add(SMaker);
        ...
        if (rType != RoadTypeEnum.NoTurnLane)
        {
            SMaker = new GSDTrafficLightSequence(false, GSDTrafficLightController.iLightControllerEnum.LeftTurn,
                GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_LeftTurnLightLength);
            FixedTimeSequenceList.Add(SMaker);
        }
        ...
        SMaker = new GSDTrafficLightSequence(true, GSDTrafficLightController.iLightControllerEnum.Red,
            GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_AllRedLightLength);
        FixedTimeSequenceList.Add(SMaker);
        SMaker = new GSDTrafficLightSequence(false, GSDTrafficLightController.iLightControllerEnum.Regular,
            GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_RegularLightLength);
        FixedTimeSequenceList.Add(SMaker);
        SMaker = new GSDTrafficLightSequence(false, GSDTrafficLightController.iLightControllerEnum.Regular,
            GSDTrafficLightController.iLightSubStatusEnum.Yellow, opt_FixedTime_YellowLightLength);
        FixedTimeSequenceList.Add(SMaker);
        SMaker = new GSDTrafficLightSequence(false, GSDTrafficLightController.iLightControllerEnum.Red,
            GSDTrafficLightController.iLightSubStatusEnum.Green, opt_FixedTime_AllRedLightLength);
        FixedTimeSequenceList.Add(SMaker);
    }
...
//			}
        ...
        {
            MarkerCenter1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterCenter-Both" + tLanes + ".mat");
            MarkerCenter2 = null;
            MarkerCenter3 = null;
        }
        else if (rType == RoadTypeEnum.TurnLane)
        {
            MarkerCenter1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterCenter-Left" + tLanes + ".mat");
            MarkerCenter2 = null;
            MarkerCenter3 = null;
        }
        else if (rType == RoadTypeEnum.NoTurnLane)
        {
            MarkerCenter1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterCenter-None" + tLanes + ".mat");
            MarkerCenter2 = null;
            MarkerCenter3 = null;
        }
    ...
    public void ResetMaterials_Ext_Stretched(bool bUpdate = true)
    {
        ...
        if (rType == RoadTypeEnum.BothTurnLanes)
        {
            MarkerExt_Stretch1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterStretch-Both" + tLanes + ".mat");
        ...
        else if (rType == RoadTypeEnum.TurnLane)
        {
            MarkerExt_Stretch1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterStretch-Left" + tLanes + ".mat");
            MarkerExt_Stretch2 = null;
            MarkerExt_Stretch3 = null;
        }
        else if (rType == RoadTypeEnum.NoTurnLane)
        {
            MarkerExt_Stretch1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterStretch-None" + tLanes + ".mat");
            MarkerExt_Stretch2 = null;
            MarkerExt_Stretch3 = null;
        }
    ...
    public void ResetMaterials_Ext_Tiled(bool bUpdate = true)
    {
        ...
        {
            MarkerExt_Tiled1 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial("Assets/RoadArchitect/Materials/GSDRoad1.mat");
            MarkerExt_Tiled2 =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDRoadDetailOverlay1.mat");
    ...
    public void ResetMaterials_Lanes(bool bUpdate = true)
    {
        ...
        if (iType == IntersectionTypeEnum.ThreeWay)
        {
            Lane1Mat1_Disabled =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterLaneDisabled.mat");
            Lane1Mat2_Disabled = null;
            if (rType == RoadTypeEnum.BothTurnLanes)
            {
                Lane1Mat1_DisabledActive =
                    GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                        "Assets/RoadArchitect/Materials/Markers/GSDInterLaneDisabledOuterRR.mat");
                Lane1Mat2_DisabledActive = null;
                Lane2Mat1_Disabled =
                    GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                        "Assets/RoadArchitect/Materials/Markers/GSDInterLaneDisabledR.mat");
            ...
            Lane2Mat1_DisabledActive =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                    "Assets/RoadArchitect/Materials/Markers/GSDInterLaneDisabledOuter" + tLanes + ".mat");
            Lane2Mat2_DisabledActive = null;
            if (rType == RoadTypeEnum.BothTurnLanes)
            {
                Lane2Mat1_DisabledActiveR =
                    GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                        "Assets/RoadArchitect/Materials/Markers/GSDInterLaneDisabledOuterR.mat");
        ...
        if (rType == RoadTypeEnum.BothTurnLanes)
        {
            Lane0Mat1 = GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                "Assets/RoadArchitect/Materials/Markers/GSDInterWhiteLYellowR" + tLanes + ".mat");
            Lane0Mat2 = null;
            Lane1Mat1 = GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                "Assets/RoadArchitect/Materials/Markers/GSDInterYellowLWhiteR.mat");
            Lane1Mat2 = null;
            Lane2Mat1 = GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                "Assets/RoadArchitect/Materials/Markers/GSDInterWhiteR" + tLanes + ".mat");
            Lane2Mat2 = null;
            Lane3Mat1 = GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                "Assets/RoadArchitect/Materials/Markers/GSDInterWhiteR.mat");
            Lane3Mat2 = null;
        }
        else if (rType == RoadTypeEnum.TurnLane)
        {
        ...
        else if (rType == RoadTypeEnum.NoTurnLane)
        {
            ...
            Lane0Mat2 = null;
            Lane1Mat1 = GSD.Roads.GSDRoadUtilityEditor.GiveMaterial(
                "Assets/RoadArchitect/Materials/Markers/GSDInterYellowLWhiteR" + tLanes + ".mat");
            Lane1Mat2 = null;
            Lane2Mat1 = null;
            Lane2Mat2 = null;
            Lane3Mat1 = null;
    ...
    private void UpdateMaterials_Do()
    {
        ...
        if (MR_Ext_Stretch != null && MR_Ext_Stretch.Count > 0)
        {
            ...
            if (MarkerExt_Stretch1 != null)
            {
                ...
                {
                    MarkerExtStretchCounter += 1;
                    if (MarkerExt_Stretch3 != null) MarkerExtStretchCounter += 1;
                }
            }

            var MarkerExtStretchMats = new Material[MarkerExtStretchCounter];
            for (var i = 0; i < MarkerExtStretchCounter; i++)
                if (i == 0)
                    MarkerExtStretchMats[i] = MarkerExt_Stretch1;
                else if (i == 1)
                    MarkerExtStretchMats[i] = MarkerExt_Stretch2;
                else if (i == 2) MarkerExtStretchMats[i] = MarkerExt_Stretch3;
            for (var i = 0; i < MR_Ext_Stretch.Count; i++) MR_Ext_Stretch[i].materials = MarkerExtStretchMats;
        }

        if (MR_Ext_Tiled != null && MR_Ext_Tiled.Count > 0)
        {
            var MarkerExtTiledCounter = 0;
            if (MarkerExt_Tiled1 != null)
            {
                ...
                {
                    MarkerExtTiledCounter += 1;
                    if (MarkerExt_Tiled3 != null) MarkerExtTiledCounter += 1;
                }
            }

            var MarkerExtTiledMats = new Material[MarkerExtTiledCounter];
            for (var i = 0; i < MarkerExtTiledCounter; i++)
                if (i == 0)
                    MarkerExtTiledMats[i] = MarkerExt_Tiled1;
                else if (i == 1)
                    MarkerExtTiledMats[i] = MarkerExt_Tiled2;
                else if (i == 2) MarkerExtTiledMats[i] = MarkerExt_Tiled3;
            for (var i = 0; i < MR_Ext_Tiled.Count; i++) MR_Ext_Tiled[i].materials = MarkerExtTiledMats;
        }
        ...
        if (MR_Center != null)
        {
            ...
            if (MarkerCenter1 != null)
            {
                ...
                {
                    CenterCounter += 1;
                    if (MarkerCenter3 != null) CenterCounter += 1;
                }
            }

            var CenterMats = new Material[CenterCounter];
            for (var i = 0; i < CenterCounter; i++)
                if (i == 0)
                    CenterMats[i] = MarkerCenter1;
                else if (i == 1)
                    CenterMats[i] = MarkerCenter2;
                else if (i == 2) CenterMats[i] = MarkerCenter3;
        ...
        if (MR_Lane0 != null && MR_Lane0.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane0Mat2 != null) LaneCounter += 1;
            }

            var Lane0Mats = new Material[LaneCounter];
            for (var i = 0; i < LaneCounter; i++)
                if (i == 0)
                    Lane0Mats[i] = Lane0Mat1;
                else if (i == 1) Lane0Mats[i] = Lane0Mat2;
            for (var i = 0; i < MR_Lane0.Count; i++) MR_Lane0[i].materials = Lane0Mats;
        }
        ...
        if (MR_Lane1 != null && MR_Lane1.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane1Mat2 != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane1Mats[i] = Lane1Mat2;
            for (var i = 0; i < MR_Lane1.Count; i++) MR_Lane1[i].materials = Lane1Mats;
        }
        ...
        if (MR_Lane2 != null && MR_Lane2.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane2Mat2 != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane2Mats[i] = Lane2Mat2;
            for (var i = 0; i < MR_Lane2.Count; i++) MR_Lane2[i].materials = Lane2Mats;
        }
        ...
        if (MR_Lane3 != null && MR_Lane3.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane3Mat2 != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane3Mats[i] = Lane3Mat2;
            for (var i = 0; i < MR_Lane3.Count; i++) MR_Lane3[i].materials = Lane3Mats;
        }
        ...
        if (MR_LaneD1 != null && MR_LaneD1.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane1Mat2_Disabled != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane1Mats_Disabled[i] = Lane1Mat2_Disabled;
            for (var i = 0; i < MR_LaneD1.Count; i++) MR_LaneD1[i].materials = Lane1Mats_Disabled;
        }
        ...
        if (MR_LaneD3 != null && MR_LaneD3.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane3Mat2_Disabled != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane3Mats_Disabled[i] = Lane3Mat2_Disabled;
            for (var i = 0; i < MR_LaneD3.Count; i++) MR_LaneD3[i].materials = Lane3Mats_Disabled;
        }
        ...
        if (MR_LaneDA2 != null && MR_LaneDA2.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane2Mat2_DisabledActive != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane2Mats_DisabledActive[i] = Lane2Mat2_DisabledActive;
            for (var i = 0; i < MR_LaneDA2.Count; i++) MR_LaneDA2[i].materials = Lane2Mats_DisabledActive;
        }
        ...
        if (MR_LaneDAR2 != null && MR_LaneDAR2.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane2Mat2_DisabledActiveR != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane2Mats_DisabledActiveR[i] = Lane2Mat2_DisabledActiveR;
            for (var i = 0; i < MR_LaneDAR2.Count; i++) MR_LaneDAR2[i].materials = Lane2Mats_DisabledActiveR;
        }
        ...
        if (MR_LaneD2 != null && MR_LaneD2.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane2Mat2_Disabled != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane2Mats_Disabled[i] = Lane2Mat2_Disabled;
            for (var i = 0; i < MR_LaneD2.Count; i++) MR_LaneD2[i].materials = Lane2Mats_Disabled;
        }
        ...
        if (MR_LaneDA1 != null && MR_LaneDA1.Count > 0)
        {
            ...
            {
                LaneCounter += 1;
                if (Lane1Mat2_DisabledActive != null) LaneCounter += 1;
            }
            ...
            for (var i = 0; i < LaneCounter; i++)
                ...
                else if (i == 1) Lane1Mats_DisabledActive[i] = Lane1Mat2_DisabledActive;
            for (var i = 0; i < MR_LaneDA1.Count; i++) MR_LaneDA1[i].materials = Lane1Mats_DisabledActive;
        }
    }
    ...
    public void ToggleTrafficLightPoleColor()
    {
        ...
        if (bTrafficLightGray)
            TrafficLightMaterial =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial("Assets/RoadArchitect/Materials/Signs/GSDInterTLB2.mat");
        else
            TrafficLightMaterial =
                GSD.Roads.GSDRoadUtilityEditor.GiveMaterial("Assets/RoadArchitect/Materials/Signs/GSDInterTLB1.mat");
        var cCount = transform.childCount;
        var tName = "";
